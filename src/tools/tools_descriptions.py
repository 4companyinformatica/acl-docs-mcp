...
tools_descriptions = {
    "mcp_get_acl_commands_or_functions_list": dedent(
        f"""
        {general_directives}
        ...
        * "How can I retrieve data ODBC in ACL?" (filtering by description)
        """).strip(),
# ==================================================
    "mcp_get_acl_command_or_function_details": dedent(
        f"""
        {general_directives}
        ...
        * "Give me an example of how to use "RECOFFSET()" in ACL Analytics" (after finding the function RECOFFSET() href, return the explanation and example using this tool)
        """).strip(),
# ==================================================
    "mcp_get_acl_scripting_tips": dedent(
        f"""
        {general_directives}
        ...
        * "Can ACL return system variables from Windows environment variables?"
        """).strip(),
# ==================================================
    "mcp_get_acl_header_tags_list": dedent(
        f"""
        {general_directives}
        ...
        * "What is the //PASSWORD tag?" (filter by tag_name)
        """).strip(),
# ==================================================
    "mcp_get_acl_header_tag_details": dedent(
        f"""
        {general_directives}
